...
public final class HeaderType {
	...
	/** The HTTP <a href="https://fetch.spec.whatwg.org/#cross-origin-resource-policy-header">{@code Cross-Origin-Resource-Policy}</a> header field name.*/
	public static final String CROSS_ORIGIN_RESOURCE_POLICY = "Cross-Origin-Resource-Policy";

	/** The HTTP <a href="https://tools.ietf.org/html/rfc8470">{@code Early-Data}</a> header field name. */
	...
	/** The HTTP <a href="https://tools.ietf.org/html/rfc7540#section-3.2.1">{@code HTTP2-Settings} </a> header field name.@since 24.0 */
	...
	/** The HTTP <a href="https://www.w3.org/TR/referrer-policy/">{@code Referrer-Policy}</a> header field name. */
	public static final String REFERRER_POLICY = "Referrer-Policy";

	/** Values for the <a href="https://www.w3.org/TR/referrer-policy/">{@code Referrer-Policy}</a> header. */
	...
	/** The HTTP <a href="https://www.w3.org/TR/service-workers/#update-algorithm">{@code Service-Worker}</a> header field name. */
	...
	/** The HTTP <a href="https://w3c.github.io/webappsec-upgrade-insecure-requests/#preference">{@code Upgrade-Insecure-Requests}</a> header field name. */
	...
	/** The HTTP <a href="http://w3.org/TR/CSP/#content-security-policy-header-field">{@code Content-Security-Policy}</a> header field name. */
	public static final String CONTENT_SECURITY_POLICY = "Content-Security-Policy";

	/** The HTTP <a href="http://w3.org/TR/CSP/#content-security-policy-report-only-header-field"> {@code Content-Security-Policy-Report-Only}</a> header field name. */
	...
	/** The HTTP <a href="https://googlechrome.github.io/OriginTrials/#header">{@code Origin-Trial}</a> header field name. */
	...
	/** The HTTP <a href="https://www.w3.org/TR/server-timing/">{@code Server-Timing}</a> header fiel name. */
	public static final String SERVER_TIMING = "Server-Timing";

	/** The HTTP <a href="https://www.w3.org/TR/service-workers/#update-algorithm">{@code Service-Worker-Allowed}</a> header field name. */
	...
	/** The HTTP <a href="http://tools.ietf.org/html/rfc6797#section-6.1">{@code Strict-Transport-Security}</a> header field name. */
	public static final String STRICT_TRANSPORT_SECURITY = "Strict-Transport-Security";

	/** The HTTP <a href="http://www.w3.org/TR/resource-timing/#cross-origin-resources">{@code Timing-Allow-Origin}</a> header field name. */
	...
	/** The HTTP <a href="https://tools.ietf.org/html/draft-ietf-tokbind-ttrp">{@code Sec-Referred-Token-Binding-ID}</a> header field name. */
	...
	/** The HTTP <a href="https://tools.ietf.org/html/rfc6455">{@code Sec-WebSocket-Protocol}</a> header field name. */
	public static final String SEC_WEBSOCKET_PROTOCOL = "Sec-WebSocket-Protocol";

	/** The HTTP <a href="https://tools.ietf.org/html/rfc6455">{@code Sec-WebSocket-Version}</a> header field name. */
